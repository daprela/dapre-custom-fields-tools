<div class="c-userFieldsMetaHeaders">
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__id">
		<?php esc_html_e("User ID","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__name">
		<?php esc_html_e("Field Name","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__actions">
		<?php esc_html_e("Actions","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__valueToAdd">
		<?php esc_html_e("Value to Add","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__prevValue">
		<?php esc_html_e("Previous Value","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__curValueUser">
		<?php esc_html_e("Current Value Options","dapre-cft") ?>
	</div>
	<div class="c-userFieldsMetaHeaders__title c-userFieldsMetaHeaders__curValue">
...
?>
<div class="js-userFieldsFieldDataRow_<?php echo $key ?> c-userField <?php echo esc_attr($user_field->get_row_error_class()) ?>">
	<div class="c-userField__fieldID">
		<input class="c-userField__fieldIDInput" type="number" step="1" min="0" name="user_id[<?php echo $key ?>]" value="<?php echo esc_attr($user_field->get_user_id()) ?>" />
	</div>
	<div class="c-userField__fieldName">
		<div class="c-userField__fieldErrorContainer">
			<p class="c-userField__fieldErrorMessage <?php echo esc_attr($user_field->get_field_error_class()) ?>"><?php echo esc_html_e($user_field->get_error(), "dapre-cft") ?></p>
		</div>
		<input class="c-userField__fieldNameInput" type="text" name="field_name[<?php echo $key ?>]" value="<?php echo esc_attr($user_field->get_name()) ?>" />
	</div>
	<div class="c-userField__fieldActions">
		<label>
	...
	<div class="c-userField__fieldValueToAdd">
		<div class="c-userField__fieldValueOptions">
			<label class="c-userField__fieldValueOptionLabel">
		...
		<textarea class="js-userFieldInputValue_<?php echo $key ?> c-userField__fieldValueToAddTextarea" name="field_value[<?php echo $key ?>]" rows="2" disabled="" ></textarea>
	...
	<div class="c-userField__fieldPrevValue">
		<?php
	...
	<div class="c-userField__fieldCurValueOptions">
		<label class="c-userField__fieldCurValueOption <?php echo esc_attr($user_field->get_date_toggle()) ?>">
			<p><?php esc_html_e("Toggle date string/timestamp","dapre-cft") ?></p>
	...
	<div class="c-userField__fieldCurValue">
