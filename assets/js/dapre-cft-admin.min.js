...
(function ($) {
  ...
  $(function () {
    ...
    $('input[name=\'copy_user_field_to\']').on('click', function () {
      if ($(_this).attr('id') === 'copy_user_field_to_user_field') {
      ...
      if ($(_this).attr('id') === 'copy_user_field_to_option') {
        $('#copy-user-field-to-post-field').slideUp('slow');
        $('#copy-user-field-to-user-field').slideUp('slow');
        $('#copy-user-field-to-option').slideDown('slow');
      }

      if ($(_this).attr('id') === 'copy_user_field_to_post_field') {
        $('#copy-user-field-to-user-field').slideUp('slow');
        $('#copy-user-field-to-option').slideUp('slow');
    ...
    $('input[name=\'copy_post_field_to\']').on('click', function () {
      if ($(_this).attr('id') === 'copy_post_field_to_user_field') {
      ...
      if ($(_this).attr('id') === 'copy_post_field_to_option') {
        $('#copy-post-field-to-post-field').slideUp('slow');
        $('#copy-post-field-to-user-field').slideUp('slow');
        $('#copy-post-field-to-option').slideDown('slow');
      }

      if ($(_this).attr('id') === 'copy_post_field_to_post_field') {
        $('#copy-post-field-to-user-field').slideUp('slow');
        $('#copy-post-field-to-option').slideUp('slow');
...
function toggleUserAction(element) {
  var index = element.dataset.index;
  var row = document.querySelector(".js-user_field_data_row_".concat(index));
  var content = document.querySelector(".js-user_field_input_value_".concat(index));
  var toggleDateCheckbox = document.querySelector(".js-user_date_string_".concat(index));
  var arrayCheckbox = document.querySelector(".js-user_empty_array_".concat(index));

  if (element.type === 'checkbox') {
    if (element.id === "user_empty_array_".concat(index)) {
      // if the user checked the empty array checkbox then disable the toggle date and return
      if (element.checked === true) {
        toggleDateCheckbox.checked = false;
        content.disabled = true;
    ...
    if (element.id === "user_date_string_".concat(index)) {
      content.disabled = false;
      arrayCheckbox.checked = false; // get the elements used to backup the values

      var dateTimestampBackup = document.querySelector(".js-user_field_input_timestamp_backup_".concat(index));
      var dateStringBackup = document.querySelector(".js-user_field_input_string_backup_".concat(index)); // if it is a number interpret as a timestamp
    ...
    if (element.id === "user_date_string_show_".concat(index)) {
      var fieldContent = document.querySelector("#user_field_value_".concat(index)); // get the elements used to backup the values

      var _dateTimestampBackup2 = document.querySelector("#user_field_value_timestamp_backup_".concat(index));

      var _dateStringBackup2 = document.querySelector("#user_field_value_string_backup_".concat(index)); // if it is a number interpret as a timestamp
...
function togglePostAction(element) {
  var index = element.dataset.index;
  var row = document.querySelector("#post_field_data_row_".concat(index));
  var content = document.querySelector("#post_field_input_value_".concat(index));
  var toggleDateCheckbox = document.querySelector("#post_date_string_".concat(index));
  var arrayCheckbox = document.querySelector("#post_empty_array_".concat(index));

  if (element.type === 'checkbox') {
    if (element.id === "post_empty_array_".concat(index)) {
      // if the user checked the empty array checkbox then disable the toggle date and return
      if (element.checked === true) {
        toggleDateCheckbox.checked = false;
        content.disabled = true;
    ...
    if (element.id === "post_date_string_".concat(index)) {
      content.disabled = false;
      arrayCheckbox.checked = false; // get the elements used to backup the values

      var dateTimestampBackup = document.querySelector("#post_field_input_timestamp_backup_".concat(index));
      var dateStringBackup = document.querySelector("#post_field_input_string_backup_".concat(index)); // if it is a number interpret as a timestamp
    ...
    if (element.id === "post_date_string_show_".concat(index)) {
      var fieldContent = document.querySelector("#post_field_value_".concat(index)); // get the elements used to backup the values

      var _dateTimestampBackup3 = document.querySelector("#post_field_value_timestamp_backup_".concat(index));

      var _dateStringBackup3 = document.querySelector("#post_field_value_string_backup_".concat(index)); // if it is a number interpret as a timestamp
