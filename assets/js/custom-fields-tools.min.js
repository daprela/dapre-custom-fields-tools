...
function FieldID(_ref) {
  ...
  var updateFieldIDValue = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (e) {
...
function MetaFieldActions(_ref) {
  ...
  var writeRef = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])();
  var delRef = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])();
...
function MetaFieldValueToAdd(props) {
  ...
  }, [action, emptyArrayRef, textAreaContent, textAreaRef, toggleDateRef]); // disable the textArea when the user checks the empty array option
...
function PostsMetaRow(props) {
  ...
  var _useState13 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])('-color-white'),
      _useState14 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState13, 2),
  ...
  var updateFieldIDValue = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (value) {
  ...
  * therefore we don't need to check. */
  ...
  var toggleDateCurrentValue = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    /* Is the current value an integer (that could be interpreted as a timestamp)? */
    if (Object(_functions__WEBPACK_IMPORTED_MODULE_10__["isInteger"])(currentValuePrinted)) {
...
function TabOptionsMeta() {
  ...
  var submitOptionsButtonRef = Object(react__WEBPACK_IMPORTED_MODULE_2__["createRef"])();
  var read = [];
  var write = [];
  var del = [];
  ...
  function refreshPage() {
    ...
    setResetPage(true);
    Object(_functions_js__WEBPACK_IMPORTED_MODULE_5__["spinnerOff"])();
  }
  ...
  function submitOptions(options) {
    ...
    Object(_functions_js__WEBPACK_IMPORTED_MODULE_5__["spinnerOn"])();
    finishedRead = false;
    readData(readLocal);
    finishedWrite = false;
    ...
    if (content === '+') {
      ...
      apiFetch({
        ...
        if (!fields.error) {
          ...
          regenerateForm([].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(rows), [newRow]));
        }
      });
    } else {
      ...
      Object(_functions_js__WEBPACK_IMPORTED_MODULE_5__["spinnerOn"])(); // submitUserButton.disabled = true;
...
function TabPostsMeta() {
  ...
  var submitPostsButtonRef = Object(react__WEBPACK_IMPORTED_MODULE_2__["createRef"])();
  var read = [];
  var write = [];
  var del = [];
  var finishedRead = false;
...
function TabUsersMeta() {
  ...
  var submitUsersButtonRef = Object(react__WEBPACK_IMPORTED_MODULE_2__["createRef"])();
  var read = [];
  var write = [];
  var del = [];
  var finishedRead = false;
...
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(wp.element.createElement(_tab_options_meta_js__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.querySelector('#optionsMetaSection'));
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(wp.element.createElement(_tab_users_meta_js__WEBPACK_IMPORTED_MODULE_3__["default"], null), document.querySelector('#usersMetaSection'));
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(wp.element.createElement(_tab_posts_meta_js__WEBPACK_IMPORTED_MODULE_4__["default"], null), document.querySelector('#postsMetaSection'));
