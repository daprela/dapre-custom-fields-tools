...
/*!***************************************!*\
  !*** ./src/js/add-remove-meta-row.js ***!
  \***************************************/
/*! exports provided: addOptionArrows, addUserArrows, addPostArrows */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addOptionArrows", function() { return addOptionArrows; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addUserArrows", function() { return addUserArrows; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addPostArrows", function() { return addPostArrows; });
...
/*!*****************************!*\
  !*** ./src/js/functions.js ***!
  \*****************************/
/*! exports provided: nameSpace, isNumber, isNormalInteger, spinnerOn, spinnerOff */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var curValueDateString = function curValueDateString(element) {
  ...
  var dateStringBackup = row.querySelector('.js-fieldValueStringBackup');
  console.log(row); // if it is a number interpret as a timestamp
...
function refreshPage(fields) {
  ...
  for (var _i = 0, _Object$keys = Object.keys(fields); _i < _Object$keys.length; _i++) {
    ...
    var field = fields[index]; // console.log(field);
  ...
  if (finishedWrite && finishedRead && finishedDel) {
    ...
    Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_1__["addOptionArrows"])();
...
function refreshPage(fields) {
  ...
  if (finishedWrite && finishedRead && finishedDel) {
    ...
    Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_1__["addPostArrows"])();
    Object(_functions_js__WEBPACK_IMPORTED_MODULE_0__["spinnerOff"])();
    finishedWrite = false;
    finishedRead = false;
    finishedDel = false;
...
var switchToOptionsTab = function switchToOptionsTab(e) {
  ...
  tab1.blur();
  Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_0__["addOptionArrows"])();
...
var switchToUsersTab = function switchToUsersTab(e) {
  ...
  tab2.blur();
  Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_0__["addUserArrows"])();
  /* deactivate other tabs and hides sections */
...
var switchToPostsTab = function switchToPostsTab(e) {
  ...
  tab3.blur();
  Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_0__["addPostArrows"])();
  /* deactivate other tabs and hides sections */
...
function refreshPage(fields) {
  ...
  if (finishedWrite && finishedRead && finishedDel) {
    ...
    Object(_add_remove_meta_row_js__WEBPACK_IMPORTED_MODULE_1__["addUserArrows"])();
    Object(_functions_js__WEBPACK_IMPORTED_MODULE_0__["spinnerOff"])();
    finishedWrite = false;
    finishedRead = false;
    finishedDel = false;
