...
function TabOptionsMeta() {
  ...
  * this form is sent to the server to get updates when the user clicks the button */
  ...
  var updateForm = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function (formRow) {
    var temp = {
      index: formRow.index,
  ...
  return wp.element.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, wp.element.createElement("div", {
    className: "js-optionsMetaSection o-meta"
  }, wp.element.createElement(_components_OptionsMetaHeaders_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
