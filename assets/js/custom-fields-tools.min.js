...
function addOptionRow(elementRow) {
  ...
  optionName.value = ''; // start removing the content of the previous row
  ...
  newRow.querySelector('.js-fieldAction[value="delete"]').disabled = true; // manages the error message
  ...
  currentValueDateToggle.classList.add('is-hidden'); // Previous value
...
optionSection.addEventListener('click', checkOptionEvent, false); // userMetaSection.addEventListener('click', checkEvent, false);
